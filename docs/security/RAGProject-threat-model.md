...
## Public abuse admission-control focused model (PR #136)

以下は、共有rate limit・concurrency・daily work-unit gateに焦点を当てた補足脅威モデルである。
RAG-31全体の上位モデルは前節を正とし、実装固有の残余リスクと復帰判断にはこの節を使う。
