...
| Evaluation behavior is explained | Required | PR-53 evaluation docs and final README explain dense/hybrid/agentic_router/graph_postgres/graph_neo4j targets, default Neo4j projection, visible Postgres graph fallback, and safe reason-code handling. |
