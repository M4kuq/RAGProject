...
GRAPH_EXTRACTION_LLM_RETRYABLE_FAILED = "graph_extraction_llm_retryable_failed"
GRAPH_EXTRACTION_LLM_PARTIAL_REBUILD_SKIPPED = "graph_extraction_llm_partial_rebuild_skipped"
