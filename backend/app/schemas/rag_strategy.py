...
class LatencyBreakdown(SafeTraceModel):
    ...
    llm_orchestrator_ms: int | None = Field(default=None, ge=0)
    llm_tool_planning_ms: int | None = Field(default=None, ge=0)
    llm_tool_execution_ms: int | None = Field(default=None, ge=0)
    langchain_agentic_ms: int | None = Field(default=None, ge=0)
    langchain_planning_ms: int | None = Field(default=None, ge=0)
    langchain_tool_execution_ms: int | None = Field(default=None, ge=0)
    langgraph_agentic_ms: int | None = Field(default=None, ge=0)
    langgraph_planning_ms: int | None = Field(default=None, ge=0)
    langgraph_tool_execution_ms: int | None = Field(default=None, ge=0)
